...
/**
 * All core test suites combined into one file.
 *
 * PHP version 5.3
 *
...
require_once "PGraphDirectedTest.php";
require_once "PGraphUndirectedTest.php";

/**
 * The class that contains all the functionality
 * combining all the core suites.
 * 
...
class PGraphCoreTests
{
    ...
    {
        $core = new PHPUnit_Framework_TestSuite('PGraph Core');
        
        $core->addTestSuite('PGraphDirectedTest');
        $core->addTestSuite('PGraphUndirectedTest');
