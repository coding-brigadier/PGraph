 ...
 */
class PGraphDirectedTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testOneEdge()
    {
        ...
        $this->assertEquals(count($neighbors2), 0);
    ...
    public function testRemoveVertexWithEdges()
    {
        ...
        $this->assertEquals(count($neighbors6), 0);
     ...
     * for finding the shortest path.
     * 
     * It gets invoked when there exists at least
     * one negative weight edge.
     * 
     * @return void
     */
